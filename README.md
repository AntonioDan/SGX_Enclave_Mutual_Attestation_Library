...
1. in "bin" sub-folder, execute "./enclavereresponder"
2. open a new concole, execute "./enclaveinitiator"
...
* libsgx_uea_key_exchange_initiator.so
...
* libsgx_uea_key_exchange_responder.so
